...
#ifndef _ANIM_UTIL_H_
#define _ANIM_UTIL_H_
...
// Read animated image data into 'AnimatedImage' struct.
// If 'dump_frames' is true, dump frames to 'dump_folder'.
// Previous content of 'image' is obliterated.
// Upon successful return, content of 'image' must be deleted by
// calling 'ClearAnimatedImage'.
bool ReadAnimatedImage(const uint8_t* data, const size_t data_size, AnimatedImage* const image,
                       int dump_frames, const wchar_t* dump_folder);
